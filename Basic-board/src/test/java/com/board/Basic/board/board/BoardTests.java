package com.board.Basic.board.board;
...
import com.board.Basic.board.entity.Board;
import com.board.Basic.board.entity.BoardRepository;
...
public class BoardTests {
    ...
    void save() {
        ...
        assertThat(entity.getWriter()).isEqualTo("개발자");
    }
